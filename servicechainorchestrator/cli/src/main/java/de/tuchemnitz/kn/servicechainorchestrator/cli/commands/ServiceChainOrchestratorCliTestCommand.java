...
public class ServiceChainOrchestratorCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ServiceChainOrchestratorCliTestCommand.class);
    protected final ServiceChainOrchestratorCliCommands service;

    public ServiceChainOrchestratorCliTestCommand(final ServiceChainOrchestratorCliCommands service) {
