...
# SDN-C
# ================================================================================
# Copyright (C) 2021 Hanif Kukkalli
...
SDNRDM_SDM_LIST=${SDNRDM_SDM_LIST:-sdnr-wt-feature-aggregator-devicemanager,sdnr-wt-devicemanager-openroadm-feature}
#SDNRDM_SDM_LIST=${SDNRDM_SDM_LIST:-sdnr-wt-devicemanager-onf-feature,sdnr-wt-devicemanager-onf14-feature,sdnr-wt-devicemanager-oran-feature,sdnr-wt-devicemanager-gran-feature,sdnr-wt-devicemanager-adapter-manager-feature,sdnr-wt-devicemanager-tr069-provider}
