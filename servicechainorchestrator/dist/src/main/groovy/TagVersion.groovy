...
def versionArray
if ( project.properties['sco.project.version'] != null ) {
    versionArray = project.properties['sco.project.version'].split('\\.')
}

if ( project.properties['sco.project.version'].endsWith("-SNAPSHOT") ) {
    ...
    project.properties['project.docker.latesttagtimestamp.version']=versionArray[0] + '.' + versionArray[1] + '.' + patchArray[0] + "-SNAPSHOT-"+project.properties['sco.build.timestamp']
} else {
    ...
    project.properties['project.docker.latesttagtimestamp.version']=versionArray[0] + '.' + versionArray[1] + '.' + versionArray[2] + "-STAGING-"+project.properties['sco.build.timestamp']
}